...
def analyze_sentiment(csv_file):
    ...
    for comment in comments:
        ...
        if num_positive > num_negative and num_positive>num_neutral:
            overall_sentiment = 'Your viewers love your content! Keep up the great work!'
        elif num_negative > num_positive and num_negative>num_neutral:
            overall_sentiment = 'Some viewers express concerns. Consider addressing their feedback to improve.'
        else:
            overall_sentiment = 'Your channel has a neutral sentiment. Engage more with your audience to understand their preferences.'

    # Return the results as a dictionary
    results = {'num_neutral': num_neutral, 'num_positive': num_positive, 'num_negative': num_negative, 'compound': overall_sentiment}
    return results
